...
class MenuDetailLoaded extends MenuDetailState {
  ...
  final int quantity;
  final Map<String, VariantOption> selectedVariants; // variantName -> selected option
  ...
  @override
  List<Object?> get props => [menuItem, quantity, selectedVariants, validationError, editCartItemId];
