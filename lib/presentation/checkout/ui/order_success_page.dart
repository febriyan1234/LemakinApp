                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoRow('Placed At', '${order!.createdAt.hour.toString().padLeft(2, '0')}:${order!.createdAt.minute.toString().padLeft(2, '0')} • ${order!.createdAt.day}/${order!.createdAt.month}/${order!.createdAt.year}'),
